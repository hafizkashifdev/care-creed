...
import ColorLegendsKey from "../../components/CL-2/CL-5/color-legends-key";
import PortalPopup from "../../components/CL-2/CL-5/portal-popup";
...
const CareLibraryProductFeatures: NextPage = () => {
  ...
  const onSecTitleContainerClick2 = useCallback(() => {
    router.push("/CL-5/care-library-carer");
  }, [router]);

  const onWdgtContainerClick93 = useCallback(() => {
    router.push("/CL-5/care-library-carer-dashboard");
  }, [router]);

  const onWdgtContainerClick94 = useCallback(() => {
    router.push("/CL-5/care-library-carer1");
  }, [router]);

  const onWdgtContainerClick95 = useCallback(() => {
    router.push("/CL-5/care-library-carer-dashboard1");
  }, [router]);

  const onWdgtContainerClick96 = useCallback(() => {
    router.push("/CL-5/care-library-carer-dashboard5");
  }, [router]);

  const onWdgtContainerClick97 = useCallback(() => {
    router.push("/CL-5/care-library-carer-dashboard4");
  }, [router]);

  const onWdgtContainerClick98 = useCallback(() => {
    router.push("/CL-5/care-library-carer-dashboard2");
  }, [router]);

  const onWdgtContainerClick99 = useCallback(() => {
    router.push("/CL-5/care-library-carer-dashboard6");
  }, [router]);

  const onWdgtContainerClick100 = useCallback(() => {
    router.push("/CL-5/care-library-carer-dashboard9");
  }, [router]);

  const onWdgtContainerClick101 = useCallback(() => {
    router.push("/CL-5/care-library-carer-dashboard7");
  }, [router]);

  const onWdgtContainerClick102 = useCallback(() => {
    router.push("/CL-5/care-library-carer-dashboard8");
  }, [router]);

  const onWdgtContainerClick103 = useCallback(() => {
    router.push("/CL-5/care-library-carer-dashboard3");
  }, [router]);

  const onWdgtContainerClick104 = useCallback(() => {
    router.push("/CL-5/care-library-carer-shift-deta");
  }, [router]);

  const onWdgtContainerClick105 = useCallback(() => {
    router.push("/CL-5/care-library-carer-shift-deta1");
  }, [router]);

  const onWdgtContainerClick106 = useCallback(() => {
    router.push("/CL-5/care-library-carer-shift-deta2");
  }, [router]);

  const onWdgtContainerClick107 = useCallback(() => {
    router.push("/CL-5/care-library-carer-shift-deta4");
  }, [router]);

  const onWdgtContainerClick108 = useCallback(() => {
    router.push("/CL-5/care-library-carer-shift-deta3");
  }, [router]);

  const onWdgtContainerClick109 = useCallback(() => {
    router.push("/CL-5/care-library-carer-ratings");
  }, [router]);

  const onWdgtContainerClick110 = useCallback(() => {
    router.push("/CL-5/care-library-carer-ratings-overall-ratings");
  }, [router]);
  ...
  const onWdgtContainerClick112 = useCallback(() => {
    router.push("/CL-5/care-library-carer-profile");
  }, [router]);

  const onWdgtContainerClick113 = useCallback(() => {
    router.push("/CL-5/care-library-carer-profile-abo");
  }, [router]);

  const onWdgtContainerClick114 = useCallback(() => {
    router.push("/CL-5/care-library-carer-profile-ref");
  }, [router]);

  const onWdgtContainerClick115 = useCallback(() => {
    router.push("/CL-5/care-library-carer-profile-tra");
  }, [router]);

  const onWdgtContainerClick116 = useCallback(() => {
    router.push("/CL-5/care-library-carer-profile-bac");
  }, [router]);

  const onWdgtContainerClick117 = useCallback(() => {
    router.push("/CL-5/care-library-carer-profile-declaration");
  }, [router]);

  const onWdgtContainerClick118 = useCallback(() => {
    router.push("/CL-5/care-library-carer-profile-medical-history");
  }, [router]);

  const onWdgtContainerClick119 = useCallback(() => {
    router.push("/CL-5/care-library-carer-profile-other-information");
  }, [router]);

  const onWdgtContainerClick120 = useCallback(() => {
    router.push("/CL-5/care-library-carer-my-calendar");
  }, [router]);

  const onWdgtContainerClick121 = useCallback(() => {
    router.push("/CL-5/care-library-carer-training");
  }, [router]);

  const onWdgtContainerClick122 = useCallback(() => {
    router.push("/CL-5/care-library-carer-reports");
  }, [router]);

  const onWdgtContainerClick123 = useCallback(() => {
    router.push("/CL-5/care-library-carer-it-help-desk");
  }, [router]);

  const onWdgtContainerClick124 = useCallback(() => {
    router.push("/CL-5/care-library-carer-it-help-desk-f-a-qs");
  }, [router]);

  const onSecTitleContainerClick3 = useCallback(() => {
    router.push("/CL-5/care-library-instructor");
  }, [router]);

  const onWdgtContainerClick125 = useCallback(() => {
    router.push("/CL-5/care-library-instructor-dashboard");
  }, [router]);

  const onWdgtContainerClick126 = useCallback(() => {
    router.push("/CL-5/care-library-instructor-dashboard-manage-course");
  }, [router]);

  const onWdgtContainerClick127 = useCallback(() => {
    router.push("/CL-5/care-library-instructor-dashboard-manage-course1");
  }, [router]);

  const onWdgtContainerClick128 = useCallback(() => {
    router.push("/CL-5/care-library-instructor-dashboard-webinar");
  }, [router]);

  const onWdgtContainerClick129 = useCallback(() => {
    router.push("/CL-5/care-library-instructor-dashboard-recent-activity");
  }, [router]);

  const onWdgtContainerClick130 = useCallback(() => {
    router.push(
      "/CL-5/care-library-instructor-dashboard-total-number-of-students"
    );
  }, [router]);

  const onWdgtContainerClick131 = useCallback(() => {
    router.push("/CL-5/care-library-instructor-dashboard-calendar");
  }, [router]);

  const onWdgtContainerClick132 = useCallback(() => {
    router.push("/CL-5/care-library-instructor-profile");
  }, [router]);

  const onWdgtContainerClick133 = useCallback(() => {
    router.push("/CL-5/care-library-instructor-profile-about-the-candidate");
  }, [router]);

  const onWdgtContainerClick134 = useCallback(() => {
    router.push("/CL-5/care-library-instructor-profile-references");
  }, [router]);

  const onWdgtContainerClick135 = useCallback(() => {
    router.push(
      "/CL-5/care-library-instructor-profile-training-and-work-history"
    );
  }, [router]);

  const onWdgtContainerClick136 = useCallback(() => {
    router.push("/CL-5/care-library-instructor-profile-declaration");
  }, [router]);

  const onWdgtContainerClick137 = useCallback(() => {
    router.push("/CL-5/care-library-instructor-profile-background-checks");
  }, [router]);

  const onWdgtContainerClick138 = useCallback(() => {
    router.push("/CL-5/care-library-instructor-profile-other-information");
  }, [router]);
      ...
      >
        ...
        >
          <Image
            ...
            height={48}
            alt=""
            src="/CL-5/iconslineararrowleft1.svg"
          />
        </Box>
        <Box
          sx={{
