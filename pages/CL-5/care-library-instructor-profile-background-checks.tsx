...
const CareLibraryInstructorProfileBackgroundChecks: NextPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            working in care roles. Instructor can indicate whether they have
            undergone a Disclosure and Barring Service (DBS) check. This is
            ...
            from care roles. Instructor can also confirm their eligibility to
            work in the UK, which is essential for compliance with employment
            laws and regulations. Instructor can save the information or proceed
            to the next section.
          </Box>
        </Box>
      </Box>
      ...
      <Image
        ...
        height={306}
        alt=""
        src="/CL-5/image-29361@2x.png"
      />
    </Box>
  );
};

export default CareLibraryInstructorProfileBackgroundChecks;
