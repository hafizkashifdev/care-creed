...
const CareLibraryCarerProfileBac: NextPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            working in care roles. Carer can indicate whether they have
            ...
            from care roles. Carer can also confirm their eligibility to work in
            the UK, which is essential for compliance with employment laws and
            regulations. Carer can save the information or proceed to the next
            section.
          </Box>
        </Box>
      </Box>
      ...
      <Image
        ...
        height={210}
        alt=""
        src="/CL-5/image-29504@2x.png"
      />
    </Box>
  );
};

export default CareLibraryCarerProfileBac;
