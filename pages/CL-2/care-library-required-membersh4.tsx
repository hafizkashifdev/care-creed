...
const CareLibraryRequiredMembersh4: NextPage = () => {
  ...
  const onFrameContainerClick = useCallback(() => {
    router.push("/CL-2/care-library-required-membersh7");
  }, [router]);

  const onFrameContainerClick1 = useCallback(() => {
    router.push("/CL-2/care-library-required-membersh9");
  }, [router]);

  const onFrameContainerClick2 = useCallback(() => {
    router.push("/CL-2/care-library-required-membersh1");
  }, [router]);

  const onFrameContainerClick3 = useCallback(() => {
    router.push("/CL-2/care-library-required-membersh5");
  }, [router]);

  const onFrameContainerClick4 = useCallback(() => {
    router.push("/CL-2/care-library-required-membersh8");
  }, [router]);

  const onFrameContainerClick5 = useCallback(() => {
    router.push("/CL-2/care-library-required-membersh2");
  }, [router]);

  const onFrameContainerClick6 = useCallback(() => {
    router.push("/CL-2/care-library-required-membersh12");
  }, [router]);

  const onFrameContainerClick7 = useCallback(() => {
    router.push("/CL-2/care-library-required-membersh3");
  }, [router]);
...
export default CareLibraryRequiredMembersh4;
