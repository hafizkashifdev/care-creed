...
const CareLibraryRequiredMembershipHomeCareWhereToApply: NextPage = () => {
            ...
            <span style={{ width: "100%" }}>
              ...
              >
                <Typography variant="inherit" component="span">
                  <Typography variant="inherit" component="span">
                    Home care providers can apply for membership through
                    associations such as the United Kingdom Homecare Association
                    (UKHCA), which provides membership for domiciliary and home
                    care agencies.
                  </Typography>
                </Typography>
              </Typography>
                ...
                <li style={{ marginBottom: "0px" }}>
                  <Typography variant="inherit" component="span">
                    <Typography
                      ...
                      component="span"
                      sx={{ fontFamily: "Inter" }}
                    >{`UKHCA membership application can be accessed at `}</Typography>
                  </Typography>
                  <a
                    style={{ color: "inherit" }}
...
export default CareLibraryRequiredMembershipHomeCareWhereToApply;
