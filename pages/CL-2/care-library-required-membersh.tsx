...
const CareLibraryRequiredMembersh: NextPage = () => {
  ...
  const onFrameContainerClick = useCallback(() => {
    router.push("/CL-2/care-library-required-membersh10");
  }, [router]);

  const onFrameContainerClick1 = useCallback(() => {
    router.push("/CL-2/care-library-required-membersh11");
  }, [router]);

  const onFrameContainerClick2 = useCallback(() => {
    router.push("/CL-2/care-library-required-membersh13");
  }, [router]);

  const onFrameContainerClick3 = useCallback(() => {
    router.push("/CL-2/care-library-required-membersh14");
  }, [router]);

  const onFrameContainerClick4 = useCallback(() => {
    router.push("/CL-2/care-library-required-membersh6");
  }, [router]);

  const onFrameContainerClick5 = useCallback(() => {
    router.push("/CL-2/care-library-required-membersh17");
  }, [router]);

  const onFrameContainerClick6 = useCallback(() => {
    router.push("/CL-2/care-library-required-membersh15");
  }, [router]);

  const onFrameContainerClick7 = useCallback(() => {
    router.push("/CL-2/care-library-required-membersh16");
  }, [router]);
...
export default CareLibraryRequiredMembersh;
