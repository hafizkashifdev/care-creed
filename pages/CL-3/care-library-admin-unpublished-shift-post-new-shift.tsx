...
const CareLibraryAdminUnpublishedShiftPostNewShift: NextPage = () => {
  ...
  return (
    ...
    >
      ...
      <Image
        ...
        height={350}
        alt=""
        src="/CL-3/image-29396@2x.png"
      />
    </Box>
  );
};

export default CareLibraryAdminUnpublishedShiftPostNewShift;
