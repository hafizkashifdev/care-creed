...
const CareLibraryAdminBookingCalendarTimeAndAttendance: NextPage = () => {
  ...
  return (
    ...
    >
      ...
      <Image
        ...
        height={416}
        alt=""
        src="/CL-3/image-29394@2x.png"
      />
    </Box>
  );
};

export default CareLibraryAdminBookingCalendarTimeAndAttendance;
