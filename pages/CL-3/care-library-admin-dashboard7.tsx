...
const CareLibraryAdminDashboard7: NextPage = () => {
  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <Typography variant="inherit" sx={{ margin: 0 }}>
              This widget manages client information, ensuring that client
              details and interactions are easily accessible and organized.
              Client widget displays pie chart that shows activity and
              inactivity during the week and cancelled
            </Typography>
            <Typography
              variant="inherit"
              sx={{ margin: 0 }}
      ...
      <Image
        ...
        height={192}
        alt=""
        src="/CL-3/image-29358@2x.png"
      />
    </Box>
  );
};

export default CareLibraryAdminDashboard7;
