...
const CareLibraryCareHomesDashboardOverallRatings: NextPage = () => {
    ...
    >
      ...
      >
        ...
        >
          ...
          >{`3.1.5 Overall Ratings `}</Typography>
          <Box
            sx={{
              alignSelf: "stretch",
              position: "relative",
          ...
          >
            Displays the overall rating received by carers.
          </Box>
        </Box>
      </Box>
      <Box
      ...
      <Image
        ...
        height={212}
        alt=""
        src="/CL-3/image-29424@2x.png"
      />
    </Box>
  );
};

export default CareLibraryCareHomesDashboardOverallRatings;
