...
import ColorLegendsKey from "../../components/CL-3/color-legends-key";
import PortalPopup from "../../components/CL-3/portal-popup";
...
const CareLibraryProductFeatures: NextPage = () => {
  ...
  const onWdgtContainerClick = useCallback(() => {
    router.push("/CL-3/care-library-k-y-c-k-y-b");
  }, [router]);

  const onWdgtContainerClick1 = useCallback(() => {
    router.push("/CL-3/care-library-admin-staff-booking-available-shifts");
  }, [router]);

  const onWdgtContainerClick2 = useCallback(() => {
    router.push("/CL-3/care-library-admin-staff-booking-completed-shifts");
  }, [router]);

  const onWdgtContainerClick3 = useCallback(() => {
    router.push("/CL-3/care-library-admin-staff-booking-upcoming-shifts");
  }, [router]);

  const onWdgtContainerClick4 = useCallback(() => {
    router.push("/CL-3/care-library-admin-staff-booking-work-history");
  }, [router]);

  const onSecTitleContainerClick = useCallback(() => {
    router.push("/CL-3/care-library-admin");
  }, [router]);

  const onWdgtContainerClick5 = useCallback(() => {
    router.push("/CL-3/care-library-admin-dashboard2");
  }, [router]);

  const onWdgtContainerClick6 = useCallback(() => {
    router.push("/CL-3/care-library-admin-client-mana");
  }, [router]);

  const onWdgtContainerClick7 = useCallback(() => {
    router.push("/CL-3/care-library-admin-staff-allocation");
  }, [router]);

  const onWdgtContainerClick8 = useCallback(() => {
    router.push("/CL-3/care-library-admin-client-mana1");
  }, [router]);

  const onWdgtContainerClick9 = useCallback(() => {
    router.push("/CL-3/care-library-admin-staff-allocation-allocate-carer");
  }, [router]);

  const onWdgtContainerClick10 = useCallback(() => {
    router.push("/CL-3/care-library-admin-onboarding");
  }, [router]);

  const onWdgtContainerClick11 = useCallback(() => {
    router.push("/CL-3/care-library-admin-staff-manag");
  }, [router]);

  const onWdgtContainerClick12 = useCallback(() => {
    router.push("/CL-3/care-library-admin-shift-manager");
  }, [router]);

  const onWdgtContainerClick13 = useCallback(() => {
    router.push("/CL-3/care-library-admin-staff-booking");
  }, [router]);

  const onWdgtContainerClick14 = useCallback(() => {
    router.push("/CL-3/care-library-admin-reports");
  }, [router]);

  const onWdgtContainerClick15 = useCallback(() => {
    router.push("/CL-3/care-library-admin-finance");
  }, [router]);

  const onWdgtContainerClick16 = useCallback(() => {
    router.push("/CL-3/care-library-admin-unpublished-shift");
  }, [router]);

  const onWdgtContainerClick17 = useCallback(() => {
    router.push("/CL-3/care-library-admin-booking-calendar");
  }, [router]);

  const onWdgtContainerClick18 = useCallback(() => {
    router.push("/CL-3/care-library-admin-dashboard-m");
  }, [router]);

  const onWdgtContainerClick19 = useCallback(() => {
    router.push("/CL-3/care-library-admin-dashboard5");
  }, [router]);

  const onWdgtContainerClick20 = useCallback(() => {
    router.push("/CL-3/care-library-admin-dashboard3");
  }, [router]);

  const onWdgtContainerClick21 = useCallback(() => {
    router.push("/CL-3/care-library-admin-dashboard");
  }, [router]);

  const onWdgtContainerClick22 = useCallback(() => {
    router.push("/CL-3/care-library-admin-dashboard4");
  }, [router]);

  const onWdgtContainerClick23 = useCallback(() => {
    router.push("/CL-3/care-library-admin-dashboard7");
  }, [router]);

  const onWdgtContainerClick24 = useCallback(() => {
    router.push("/CL-3/care-library-admin-dashboard-s");
  }, [router]);

  const onWdgtContainerClick25 = useCallback(() => {
    router.push("/CL-3/care-library-admin-dashboard6");
  }, [router]);

  const onWdgtContainerClick26 = useCallback(() => {
    router.push("/CL-3/care-library-admin-dashboard-r");
  }, [router]);

  const onWdgtContainerClick27 = useCallback(() => {
    router.push("/CL-3/care-library-admin-dashboard1");
  }, [router]);

  const onWdgtContainerClick28 = useCallback(() => {
    router.push("/CL-3/care-library-admin-staff-manag1");
  }, [router]);

  const onWdgtContainerClick29 = useCallback(() => {
    router.push(
      "/CL-3/care-library-admin-staff-manager-send-resend-invitation"
    );
  }, [router]);

  const onWdgtContainerClick30 = useCallback(() => {
    router.push("/CL-3/care-library-admin-staff-manag2");
  }, [router]);

  const onWdgtContainerClick31 = useCallback(() => {
    router.push("/CL-3/care-library-admin-staff-manager-allocate-staff");
  }, [router]);

  const onWdgtContainerClick32 = useCallback(() => {
    router.push("/CL-3/care-library-admin-staff-manag3");
  }, [router]);

  const onWdgtContainerClick33 = useCallback(() => {
    router.push("/CL-3/care-library-admin-staff-manager-delete");
  }, [router]);

  const onWdgtContainerClick34 = useCallback(() => {
    router.push("/CL-3/care-library-admin-shift-manager-shift-request");
  }, [router]);

  const onWdgtContainerClick35 = useCallback(() => {
    router.push("/CL-3/care-library-admin-shift-manager-confirmed-shift");
  }, [router]);

  const onWdgtContainerClick36 = useCallback(() => {
    router.push("/CL-3/care-library-admin-shift-manager-post-new-shift");
  }, [router]);

  const onWdgtContainerClick37 = useCallback(() => {
    router.push("/CL-3/care-library-admin-shift-manager-unfilled-shifts");
  }, [router]);

  const onWdgtContainerClick38 = useCallback(() => {
    router.push("/CL-3/care-library-admin-shift-manager-book-staff-direct");
  }, [router]);

  const onWdgtContainerClick39 = useCallback(() => {
    router.push("/CL-3/care-library-admin-shift-manager-shifts-calendar");
  }, [router]);

  const onWdgtContainerClick40 = useCallback(() => {
    router.push("/CL-3/care-library-admin-unpublished-shift-post-new-shift");
  }, [router]);

  const onWdgtContainerClick41 = useCallback(() => {
    router.push("/CL-3/care-library-admin-unpublished-shift-delete-shift");
  }, [router]);

  const onWdgtContainerClick42 = useCallback(() => {
    router.push("/CL-3/care-library-admin-unpublished-shift-book-staff-direct");
  }, [router]);

  const onWdgtContainerClick43 = useCallback(() => {
    router.push("/CL-3/care-library-admin-booking-calendar-time-sheet");
  }, [router]);

  const onWdgtContainerClick44 = useCallback(() => {
    router.push(
      "/CL-3/care-library-admin-booking-calendar-time-and-attendance"
    );
  }, [router]);

  const onWdgtContainerClick45 = useCallback(() => {
    router.push("/CL-3/care-library-admin-finance-dashboard");
  }, [router]);

  const onWdgtContainerClick46 = useCallback(() => {
    router.push("/CL-3/care-library-admin-finance-setup");
  }, [router]);

  const onWdgtContainerClick47 = useCallback(() => {
    router.push(
      "/CL-3/care-library-admin-finance-dashboard-account-receivable"
    );
  }, [router]);

  const onWdgtContainerClick48 = useCallback(() => {
    router.push(
      "/care-library-admin-finance-dashboard-clients-wise-average-profit"
    );
  }, [router]);

  const onWdgtContainerClick49 = useCallback(() => {
    router.push(
      "/care-library-admin-finance-dashboard-week-wise-shift-hours-summary"
    );
  }, [router]);

  const onWdgtContainerClick50 = useCallback(() => {
    router.push("/CL-3/care-library-admin-finance-dashboard-top-clients");
  }, [router]);

  const onWdgtContainerClick51 = useCallback(() => {
    router.push("/CL-3/care-library-admin-finance-dashboard-amount-receivable");
  }, [router]);

  const onWdgtContainerClick52 = useCallback(() => {
    router.push(
      "/care-library-admin-finance-dashboard-weekwise-clients-profit"
    );
  }, [router]);

  const onWdgtContainerClick53 = useCallback(() => {
    router.push(
      "/CL-3/care-library-admin-finance-dashboard-revenue-comparison"
    );
  }, [router]);

  const onWdgtContainerClick54 = useCallback(() => {
    router.push("/CL-3/care-library-admin-finance-dashboard-staff-categories");
  }, [router]);

  const onWdgtContainerClick55 = useCallback(() => {
    router.push("/CL-3/care-library-admin-finance-invoice");
  }, [router]);

  const onWdgtContainerClick56 = useCallback(() => {
    router.push("/CL-3/care-library-admin-finance-client-payment-details");
  }, [router]);

  const onWdgtContainerClick57 = useCallback(() => {
    router.push("/CL-3/care-library-admin-finance-reports");
  }, [router]);

  const onWdgtContainerClick58 = useCallback(() => {
    router.push("/CL-3/care-library-admin-finance-staff-payment-details");
  }, [router]);

  const onWdgtContainerClick59 = useCallback(() => {
    router.push("/CL-3/care-library-admin-finance-setup-client-rate-setup");
  }, [router]);

  const onWdgtContainerClick60 = useCallback(() => {
    router.push("/CL-3/care-library-admin-finance-setup-staff-code-setup");
  }, [router]);

  const onWdgtContainerClick61 = useCallback(() => {
    router.push("/CL-3/care-library-admin-finance-setup-staff-rate-setup");
  }, [router]);
  ...
  const onWdgtContainerClick139 = useCallback(() => {
    // Please sync "6.3 Care Library Instructor Manage Courses" to the project
  }, []);

  const onWdgtContainerClick140 = useCallback(() => {
    // Please sync "6.4 Care Library Instructor Training Info" to the project
  }, []);

  const onWdgtContainerClick141 = useCallback(() => {
    // Please sync "6.5 Care Library Instructor Webinar" to the project
  }, []);

  const onWdgtContainerClick142 = useCallback(() => {
    // Please sync "6.6 Care Library Instructor Reports" to the project
  }, []);

  const onSecTitleContainerClick4 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes");
  }, [router]);

  const onWdgtContainerClick143 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-dashboard");
  }, [router]);

  const onWdgtContainerClick144 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-profil");
  }, [router]);

  const onWdgtContainerClick145 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-manage");
  }, [router]);

  const onWdgtContainerClick146 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-rating2");
  }, [router]);

  const onWdgtContainerClick147 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-bookin");
  }, [router]);

  const onWdgtContainerClick148 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-user-m");
  }, [router]);

  const onWdgtContainerClick149 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-prefer");
  }, [router]);

  const onWdgtContainerClick150 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-dashboard-upcoming-shifts");
  }, [router]);

  const onWdgtContainerClick151 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-dashboard-available-shifts");
  }, [router]);

  const onWdgtContainerClick152 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-dashboard-last-shift-details");
  }, [router]);
  ...
  const onWdgtContainerClick156 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-dashboard-overall-ratings");
  }, [router]);

  const onWdgtContainerClick157 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-profil2");
  }, [router]);

  const onWdgtContainerClick158 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-profil1");
  }, [router]);

  const onWdgtContainerClick159 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-profil3");
  }, [router]);

  const onWdgtContainerClick160 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-profil4");
  }, [router]);

  const onWdgtContainerClick161 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-profil6");
  }, [router]);

  const onWdgtContainerClick162 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-profil5");
  }, [router]);

  const onWdgtContainerClick163 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-profil7");
  }, [router]);

  const onWdgtContainerClick164 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-manage2");
  }, [router]);

  const onWdgtContainerClick165 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-manage1");
  }, [router]);

  const onWdgtContainerClick166 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-manage4");
  }, [router]);

  const onWdgtContainerClick167 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-manage3");
  }, [router]);

  const onWdgtContainerClick168 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-rating");
  }, [router]);

  const onWdgtContainerClick169 = useCallback(() => {
    router.push("/CL-3/care-library-care-homes-rating1");
  }, [router]);

  const onWdgtContainerClick170 = useCallback(() => {
    router.push("/CL-3/care-library-admin-onboarding1");
  }, [router]);

  const onWdgtContainerClick171 = useCallback(() => {
    router.push("/CL-3/care-library-admin-onboarding2");
  }, [router]);

  const onWdgtContainerClick172 = useCallback(() => {
    router.push("/CL-3/care-library-admin-onboarding3");
  }, [router]);
      ...
      >
        ...
        >
          <Image
            ...
            height={48}
            alt=""
            src="/CL-3/iconslineararrowleft2.svg"
          />
        </Box>
        <Box
          sx={{
