...
import ColorLegendsKey from "../../components/CL-2/CL-4/color-legends-key";
import PortalPopup from "../../components/CL-2/CL-4/portal-popup";
...
const CareLibraryProductFeatures: NextPage = () => {
  ...
  const onSecTitleContainerClick1 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator");
  }, [router]);

  const onWdgtContainerClick62 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator-dashboard");
  }, [router]);

  const onWdgtContainerClick63 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator-manage-shifts");
  }, [router]);

  const onWdgtContainerClick64 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator-staff-allocation");
  }, [router]);

  const onWdgtContainerClick65 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator-finance");
  }, [router]);

  const onWdgtContainerClick66 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator-training");
  }, [router]);

  const onWdgtContainerClick67 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator-reports");
  }, [router]);

  const onWdgtContainerClick68 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator-dashboard-shift-requests");
  }, [router]);

  const onWdgtContainerClick69 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator-dashboard-shift-bookings");
  }, [router]);

  const onWdgtContainerClick70 = useCallback(() => {
    router.push(
      "/CL-4/care-library-care-coordinator-dashboard-whistle-blowing"
    );
  }, [router]);

  const onWdgtContainerClick71 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator-dashboard-shift-insight");
  }, [router]);
  ...
  const onWdgtContainerClick73 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator-dashboard-calendar");
  }, [router]);

  const onWdgtContainerClick74 = useCallback(() => {
    router.push(
      "/CL-4/care-library-care-coordinator-dashboard-top-rated-carers"
    );
  }, [router]);

  const onWdgtContainerClick75 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator-dashboard-carers-status");
  }, [router]);

  const onWdgtContainerClick76 = useCallback(() => {
    router.push(
      "/CL-4/care-library-care-coordinator-manage-shifts-shift-request"
    );
  }, [router]);

  const onWdgtContainerClick77 = useCallback(() => {
    router.push(
      "/CL-4/care-library-care-coordinator-manage-shifts-post-new-shift"
    );
  }, [router]);

  const onWdgtContainerClick78 = useCallback(() => {
    router.push(
      "/CL-4/care-library-care-coordinator-manage-shifts-book-staff-direct"
    );
  }, [router]);

  const onWdgtContainerClick79 = useCallback(() => {
    router.push(
      "/CL-4/care-library-care-coordinator-manage-shifts-shift-calendar"
    );
  }, [router]);

  const onWdgtContainerClick80 = useCallback(() => {
    router.push(
      "/CL-4/care-library-care-coordinator-manage-shifts-unfilled-shifts"
    );
  }, [router]);

  const onWdgtContainerClick81 = useCallback(() => {
    router.push(
      "/CL-4/care-library-care-coordinator-manage-shifts-confirmed-shift"
    );
  }, [router]);

  const onWdgtContainerClick82 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator-booking-calendar");
  }, [router]);

  const onWdgtContainerClick83 = useCallback(() => {
    router.push(
      "/CL-4/care-library-care-coordinator-booking-calendar-time-sheet"
    );
  }, [router]);

  const onWdgtContainerClick84 = useCallback(() => {
    router.push(
      "/CL-4/care-library-care-coordinator-booking-calendar-time-and-attendance"
    );
  }, [router]);

  const onWdgtContainerClick85 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator-profile");
  }, [router]);

  const onWdgtContainerClick86 = useCallback(() => {
    router.push(
      "/CL-4/care-library-care-coordinator-profile-about-the-candidate"
    );
  }, [router]);

  const onWdgtContainerClick87 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator-profile-references");
  }, [router]);

  const onWdgtContainerClick88 = useCallback(() => {
    router.push(
      "/CL-4/care-library-care-coordinator-profile-training-and-work-history"
    );
  }, [router]);

  const onWdgtContainerClick89 = useCallback(() => {
    router.push(
      "/CL-4/care-library-care-coordinator-profile-background-checks"
    );
  }, [router]);

  const onWdgtContainerClick90 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator-profile-declaration");
  }, [router]);

  const onWdgtContainerClick91 = useCallback(() => {
    router.push("/CL-4/care-library-care-coordinator-profile-medical-history");
  }, [router]);

  const onWdgtContainerClick92 = useCallback(() => {
    router.push(
      "/CL-4/care-library-care-coordinator-profile-other-information"
    );
  }, [router]);
      ...
      >
        ...
        >
          <Image
            ...
            height={48}
            alt=""
            src="/CL-4/iconslineararrowleft.svg"
          />
        </Box>
        <Box
          sx={{
          ...
          >
            ...
            >
              ...
              <Image
                ...
                height={9}
                alt=""
                src="/CL-4/accountanthelpsquad-logo-1@2x.png"
              />
            </Box>
            <Box
              sx={{
            ...
            >
              ...
              <Image
                ...
                height={37}
                alt=""
                src="/CL-4/care-library-1@2x.png"
              />
            </Box>
            <Box
              sx={{
            ...
            >
              ...
              <Image
                ...
                height={30}
                alt=""
                src="/CL-4/film-hs-logo-1@2x.png"
              />
            </Box>
            <Box
              sx={{
            ...
            >
              ...
              <Image
                ...
                height={20}
                alt=""
                src="/CL-4/fosterapp-logo-1@2x.png"
              />
            </Box>
            <Box
              sx={{
            ...
            >
              ...
              <Image
                ...
                height={20}
                alt=""
                src="/CL-4/startuphs-logo-1@2x.png"
              />
            </Box>
            <Box
              sx={{
            ...
            >
              ...
              <Image
                ...
                height={24}
                alt=""
                src="/CL-4/reference-tok-1@2x.png"
              />
            </Box>
            <Box
              sx={{
            ...
            >
              ...
              <Image
                ...
                height={16}
                alt=""
                src="/CL-4/mortagage-basket-1@2x.png"
              />
            </Box>
            <Box
              sx={{
            ...
            >
              ...
              <Image
                ...
                height={23}
                alt=""
                src="/CL-4/emirbanq-logo-1@2x.png"
              />
            </Box>
            <Box
              sx={{
            ...
            >
              <Image
                ...
                height={33}
                alt=""
                src="/CL-4/student-helpsquad-1@2x.png"
              />
              <Box
                sx={{
                  position: "absolute",
            ...
            >
              ...
              <Image
                ...
                height={24}
                alt=""
                src="/CL-4/compliance-sheet-logo-1@2x.png"
              />
            </Box>
          </Box>
        </Box>
          ...
          >
            ...
            >
              ...
              <Image
                ...
                height={37}
                alt=""
                src="/CL-4/care-library-11@2x.png"
              />
            </Box>
            <Box
              sx={{
