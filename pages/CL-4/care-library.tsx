...
const CareLibrary: NextPage = () => {
  ...
  const onWdgtContainerClick1 = useCallback(() => {
    // Please sync "Care Library Product Features (Release 2)" to the project
  }, []);

  const onWdgtContainerClick2 = useCallback(() => {
    // Please sync "Care Library Product Competitors" to the project
  }, []);

  const onWdgtContainerClick3 = useCallback(() => {
    // Please sync "Care Library  Supporting Documents/ Guidelines" to the project
  }, []);

  const onWdgtContainerClick4 = useCallback(() => {
    // Please sync "Care Library Third Party APIs" to the project
  }, []);

  const onWdgtContainerClick5 = useCallback(() => {
    // Please sync "Consultancy Outfit Tools" to the project
  }, []);

  const onWdgtContainerClick6 = useCallback(() => {
    // Please sync "Care Library Social Media Accounts" to the project
  }, []);

  const onWdgtContainerClick7 = useCallback(() => {
    // Please sync "Care Library Chat GPT 4 Training" to the project
  }, []);
  ...
  const onWdgtContainerClick11 = useCallback(() => {
    // Please sync "Care Library Required Memberships" to the project
  }, []);
  ...
  const onWdgtContainerClick14 = useCallback(() => {
    // Please sync "Care Library Subject Access Request (SAR)" to the project
  }, []);

  const onWdgtContainerClick15 = useCallback(() => {
    // Please sync "Care Library COBIT Implementation" to the project
  }, []);

  const onWdgtContainerClick16 = useCallback(() => {
    // Please sync "Care Library Required Certifications / Qualifications" to the project
  }, []);

  const onWdgtContainerClick17 = useCallback(() => {
    // Please sync "Care Library Job Roles" to the project
  }, []);

  const onWdgtContainerClick18 = useCallback(() => {
    // Please sync "Care Library Modification Dates" to the project
  }, []);

  const onWdgtContainerClick19 = useCallback(() => {
    // Please sync "LARS Courses Classification" to the project
  }, []);

  const onWdgtContainerClick20 = useCallback(() => {
    // Please sync "Color Legends (Key)" to the project
  }, []);
  ...
  const onWdgtContainerClick23 = useCallback(() => {
    // Please sync "Practical Law" to the project
  }, []);
        ...
        >
          ...
          >
            <Image
              ...
              height={200}
              alt=""
              src="/CL-4/chatgptlogotransparentfreepng-1@2x.png"
            />
            <Box
              sx={{
                alignSelf: "stretch",
          ...
          >
            <Image
              ...
              height={192}
              alt=""
              src="/CL-4/laremovebgpreview-1@2x.png"
            />
            <Box
              sx={{
                alignSelf: "stretch",
          ...
          >
            <Image
              ...
              height={154}
              alt=""
              src="/CL-4/clipart2564799-1@2x.png"
            />
            <Box
              sx={{
                alignSelf: "stretch",
          ...
          >
            <Image
              ...
              height={200}
              alt=""
              src="/CL-4/cobitremovebgpreview-1@2x.png"
            />
            <Box
              sx={{
                alignSelf: "stretch",
          ...
          >
            <Image
              ...
              height={151}
              alt=""
              src="/CL-4/dashboardicon23-1@2x.png"
            />
            <Box
              sx={{
                alignSelf: "stretch",
