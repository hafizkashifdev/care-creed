...
const CareLibraryCareCoordinatorManageShiftsPostNewShift: NextPage = () => {
    ...
    >
      ...
      >
        ...
        >
          ...
          >{`4.2.2 Post New Shift `}</Typography>
          <Box
            sx={{
              alignSelf: "stretch",
              position: "relative",
...
export default CareLibraryCareCoordinatorManageShiftsPostNewShift;
