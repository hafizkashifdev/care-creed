...
const CareLibraryCareCoordinatorManageShiftsConfirmedShift: NextPage = () => {
    ...
    >
      ...
      >
        ...
        >
          ...
          >{`4.2.4 Confirmed Shift `}</Typography>
          <Box
            sx={{
              alignSelf: "stretch",
              position: "relative",
...
export default CareLibraryCareCoordinatorManageShiftsConfirmedShift;
