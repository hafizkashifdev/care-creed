...
const CareLibraryRequiredLicensesInformationCommissionersOfficeICO: NextPage =
  () => {
...
export default CareLibraryRequiredLicensesInformationCommissionersOfficeICO;
